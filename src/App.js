...
function App() {
  ...
  const url_for_getting_data = `http://127.0.0.1:8000/api/conversations/eighitConversations/`;
  const urlForGettingUniqueId = `http://127.0.0.1:8000/generate_unique_id/`; // 替换为实际的后端URL
  useEffect(() => {
      // API url
